...
let textArray = new Array(1214);
let second = 60, wordsCnt = 0, record = 0, accuracy = 0, prevInd = 0;
let timer;
let start = false;
...
function addText() {
    let text = "I live in a house near the mountains. I have two brothers and one sister, and I was born last. My father teaches history, and my mother is a nurse at a big hospital. " + 
